...
inline void to_yaml(
  const dave_interfaces::srv::Dock_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const dave_interfaces::srv::Dock_Request & msg)
{
  return dave_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<dave_interfaces::srv::Dock_Request>()
{
  return "dave_interfaces::srv::Dock_Request";
}

template<>
inline const char * name<dave_interfaces::srv::Dock_Request>()
{
  return "dave_interfaces/srv/Dock_Request";
}
...
[[deprecated("use dave_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const dave_interfaces::srv::Dock_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  dave_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use dave_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const dave_interfaces::srv::Dock_Response & msg)
{
  return dave_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<dave_interfaces::srv::Dock_Response>()
{
  return "dave_interfaces::srv::Dock_Response";
}

template<>
inline const char * name<dave_interfaces::srv::Dock_Response>()
{
  return "dave_interfaces/srv/Dock_Response";
}
...
template<>
inline const char * data_type<dave_interfaces::srv::Dock>()
{
  return "dave_interfaces::srv::Dock";
}

template<>
inline const char * name<dave_interfaces::srv::Dock>()
{
  return "dave_interfaces/srv/Dock";
}
