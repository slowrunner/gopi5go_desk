...
#ifndef GPG3_MSGS__MSG__DETAIL__SENSOR_STATE__TRAITS_HPP_
#define GPG3_MSGS__MSG__DETAIL__SENSOR_STATE__TRAITS_HPP_
...
inline void to_yaml(
  const gpg3_msgs::msg::SensorState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const gpg3_msgs::msg::SensorState & msg)
{
  return gpg3_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<gpg3_msgs::msg::SensorState>()
{
  return "gpg3_msgs::msg::SensorState";
}

template<>
inline const char * name<gpg3_msgs::msg::SensorState>()
{
  return "gpg3_msgs/msg/SensorState";
}

template<>
struct has_fixed_size<gpg3_msgs::msg::SensorState>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<gpg3_msgs::msg::SensorState>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<gpg3_msgs::msg::SensorState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // GPG3_MSGS__MSG__DETAIL__SENSOR_STATE__TRAITS_HPP_
