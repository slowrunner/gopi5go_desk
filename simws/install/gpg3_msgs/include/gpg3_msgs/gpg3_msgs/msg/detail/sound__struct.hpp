...
#ifndef GPG3_MSGS__MSG__DETAIL__SOUND__STRUCT_HPP_
#define GPG3_MSGS__MSG__DETAIL__SOUND__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__gpg3_msgs__msg__Sound __attribute__((deprecated))
#else
# define DEPRECATED__gpg3_msgs__msg__Sound __declspec(deprecated)
#endif
...
#  pragma pop_macro("ERROR")
  ...
  // pointer types
  using RawPtr =
    gpg3_msgs::msg::Sound_<ContainerAllocator> *;
  using ConstRawPtr =
    const gpg3_msgs::msg::Sound_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<gpg3_msgs::msg::Sound_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<gpg3_msgs::msg::Sound_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      gpg3_msgs::msg::Sound_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<gpg3_msgs::msg::Sound_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<gpg3_msgs::msg::Sound_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<gpg3_msgs::msg::Sound_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<gpg3_msgs::msg::Sound_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__gpg3_msgs__msg__Sound
    std::shared_ptr<gpg3_msgs::msg::Sound_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__gpg3_msgs__msg__Sound
    std::shared_ptr<gpg3_msgs::msg::Sound_<ContainerAllocator> const>
...
using Sound =
  gpg3_msgs::msg::Sound_<std::allocator<void>>;
...
#endif  // GPG3_MSGS__MSG__DETAIL__SOUND__STRUCT_HPP_
