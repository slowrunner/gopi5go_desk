...
{
  new (message_memory) gpg3_msgs::msg::VersionInfo(_init);
}

void VersionInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gpg3_msgs::msg::VersionInfo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VersionInfo_message_member_array[3] = {
  {
    ...
    offsetof(gpg3_msgs::msg::VersionInfo, hardware),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gpg3_msgs::msg::VersionInfo, firmware),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gpg3_msgs::msg::VersionInfo, software),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VersionInfo_message_members = {
  ...
  3,  // number of fields
  sizeof(gpg3_msgs::msg::VersionInfo),
...
get_message_type_support_handle<gpg3_msgs::msg::VersionInfo>()
{
  return &::gpg3_msgs::msg::rosidl_typesupport_introspection_cpp::VersionInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpg3_msgs, msg, VersionInfo)() {
  return &::gpg3_msgs::msg::rosidl_typesupport_introspection_cpp::VersionInfo_message_type_support_handle;
}
