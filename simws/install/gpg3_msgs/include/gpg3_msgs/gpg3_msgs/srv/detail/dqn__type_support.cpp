...
{
  new (message_memory) gpg3_msgs::srv::Dqn_Request(_init);
}

void Dqn_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gpg3_msgs::srv::Dqn_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Dqn_Request_message_member_array[2] = {
  {
    ...
    offsetof(gpg3_msgs::srv::Dqn_Request, action),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gpg3_msgs::srv::Dqn_Request, init),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Dqn_Request_message_members = {
  "gpg3_msgs::srv",  // message namespace
  "Dqn_Request",  // message name
  2,  // number of fields
  sizeof(gpg3_msgs::srv::Dqn_Request),
...
get_message_type_support_handle<gpg3_msgs::srv::Dqn_Request>()
{
  return &::gpg3_msgs::srv::rosidl_typesupport_introspection_cpp::Dqn_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpg3_msgs, srv, Dqn_Request)() {
  return &::gpg3_msgs::srv::rosidl_typesupport_introspection_cpp::Dqn_Request_message_type_support_handle;
}
...
void Dqn_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) gpg3_msgs::srv::Dqn_Response(_init);
}

void Dqn_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gpg3_msgs::srv::Dqn_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Dqn_Response_message_member_array[3] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gpg3_msgs::srv::Dqn_Response, state),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gpg3_msgs::srv::Dqn_Response, reward),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gpg3_msgs::srv::Dqn_Response, done),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Dqn_Response_message_members = {
  ...
  3,  // number of fields
  sizeof(gpg3_msgs::srv::Dqn_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<gpg3_msgs::srv::Dqn_Response>()
{
  return &::gpg3_msgs::srv::rosidl_typesupport_introspection_cpp::Dqn_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpg3_msgs, srv, Dqn_Response)() {
  return &::gpg3_msgs::srv::rosidl_typesupport_introspection_cpp::Dqn_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Dqn_service_members = {
  "gpg3_msgs::srv",  // service namespace
  "Dqn",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<gpg3_msgs::srv::Dqn>()
...
get_service_type_support_handle<gpg3_msgs::srv::Dqn>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::gpg3_msgs::srv::rosidl_typesupport_introspection_cpp::Dqn_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpg3_msgs, srv, Dqn)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<gpg3_msgs::srv::Dqn>();
}
