...
#ifndef GPG3_FAKE_NODE__GPG3_FAKE_NODE_HPP_
#define GPG3_FAKE_NODE__GPG3_FAKE_NODE_HPP_
...
#include "gpg3_msgs/msg/sensor_state.hpp"

#define LEFT 0
#define RIGHT 1

class GPG3Fake : public rclcpp::Node
{
public:
  GPG3Fake();
  ~GPG3Fake();
...
#endif  // GPG3_FAKE_NODE__GPG3_FAKE_NODE_HPP_
